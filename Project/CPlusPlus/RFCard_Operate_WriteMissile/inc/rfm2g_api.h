...
===============================================================================
    ...
    Copyright (C) 2001, 2006, 2008-10 GE Intelligent Platforms Embedded Systems, Inc.
...
/* NOTE: Application programs should not use the following functions unless
         directed to do so by GE Intelligent Platforms Embedded Systems, Inc. support
         personnel. */
