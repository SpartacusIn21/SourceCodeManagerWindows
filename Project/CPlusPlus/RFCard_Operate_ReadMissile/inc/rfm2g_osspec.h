 ...
 *                       COPYRIGHT NOTICE
 *
 *  Copyright (C) 1997-2010 GE Intelligent Platforms Embedded Systems, Inc, Inc.
...
#else
	#if defined(DEFINE_CODE)
		#define	DECL_SPEC(Type)	_LibDeclSpec __declspec(dllexport)  Type	__cdecl
	#else
		#define	DECL_SPEC(Type)	Type	__cdecl
	#endif
...
#define	PLX_FLUSH()		{ ULONG32 Dummy = (UCHAR)(pPBase->rfm3rr_cmd); }
